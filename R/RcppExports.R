...
stappDP_fit <- function(y, Z, X, w, nu_0, alpha_a, alpha_b, K, iter_max, burn_in, thin, seed, num_posterior_samples) {
    .Call(`_rstapDP_stappDP_fit`, y, Z, X, w, nu_0, alpha_a, alpha_b, K, iter_max, burn_in, thin, seed, num_posterior_samples)
}
