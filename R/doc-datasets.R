...
#'
#' @name FFR_benvo
#' @format  A \code{\link[rbenvo]{benvo}} consisting of the \code{FFR_subjects}
#' and \code{FFR_distances} dataframes
#' @details see \code{\link{FFR_subjects}} and \code{\link{FFR_distances}}
#' For information on the dataframes.
#' @format  subject data: A data frame with 1000 rows and 3 columns
#' \describe{
...
#' }
#' @format  Distance data: A data frame with 9501 rows and 2 columns
#' \describe{
#' \item{ \code{id}}{ The subject unique identifier}
#' \item{\code{Distance}}{The simulated distance between a hypothetical subject
...
#' @format A \code{\link[rbenvo]{benvo}} consisting of a subject and
#' subject-distance dataframes
#' @details The outcome in the subject dataframe is simulated using a cluster
#' specific effect as follows:
#' \deqn{E[Y_{ij}|b_{i1},b_{i2}] = 33  - 2.2 \text{sex}_i + .1*(year_{ij}) +
#' f_k(\text{FFR exposure}) +b_{i1} + b_{i2}(year_{ij})  } Where \eqn{k= 1,2,3}
#' with varying probabilities.
#' @seealso the generating
#' \href{https://github.com/apeterson91/rstapDP/tree/master/data-raw}{code} on
#' Github.
#'
