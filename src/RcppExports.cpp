...
// stappDP_mer_fit
Rcpp::List stappDP_mer_fit(const Eigen::VectorXd& y, const Eigen::MatrixXd& Z, const Eigen::MatrixXd& X, const Eigen::ArrayXXd& W, const Eigen::MatrixXd& S, const Eigen::VectorXd& w, const SEXP& subj_mat_, const Eigen::ArrayXi& subj_n, const Eigen::ArrayXi& num_penalties, const double& alpha_a, const double& alpha_b, const double& sigma_a, const double& sigma_b, const double& tau_a, const double& tau_b, const int& K, const int& iter_max, const int& burn_in, const int& thin, const int& seed, const int& num_posterior_samples, const bool& fix_alpha, const int& P_two, const Eigen::ArrayXi& P_twoi);
RcppExport SEXP _rstapDP_stappDP_mer_fit(SEXP ySEXP, SEXP ZSEXP, SEXP XSEXP, SEXP WSEXP, SEXP SSEXP, SEXP wSEXP, SEXP subj_mat_SEXP, SEXP subj_nSEXP, SEXP num_penaltiesSEXP, SEXP alpha_aSEXP, SEXP alpha_bSEXP, SEXP sigma_aSEXP, SEXP sigma_bSEXP, SEXP tau_aSEXP, SEXP tau_bSEXP, SEXP KSEXP, SEXP iter_maxSEXP, SEXP burn_inSEXP, SEXP thinSEXP, SEXP seedSEXP, SEXP num_posterior_samplesSEXP, SEXP fix_alphaSEXP, SEXP P_twoSEXP, SEXP P_twoiSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< const Eigen::ArrayXi& >::type num_penalties(num_penaltiesSEXP);
    Rcpp::traits::input_parameter< const double& >::type alpha_a(alpha_aSEXP);
    Rcpp::traits::input_parameter< const double& >::type alpha_b(alpha_bSEXP);
    Rcpp::traits::input_parameter< const double& >::type sigma_a(sigma_aSEXP);
    Rcpp::traits::input_parameter< const double& >::type sigma_b(sigma_bSEXP);
    ...
    Rcpp::traits::input_parameter< const int& >::type num_posterior_samples(num_posterior_samplesSEXP);
    Rcpp::traits::input_parameter< const bool& >::type fix_alpha(fix_alphaSEXP);
    Rcpp::traits::input_parameter< const int& >::type P_two(P_twoSEXP);
    Rcpp::traits::input_parameter< const Eigen::ArrayXi& >::type P_twoi(P_twoiSEXP);
    rcpp_result_gen = Rcpp::wrap(stappDP_mer_fit(y, Z, X, W, S, w, subj_mat_, subj_n, num_penalties, alpha_a, alpha_b, sigma_a, sigma_b, tau_a, tau_b, K, iter_max, burn_in, thin, seed, num_posterior_samples, fix_alpha, P_two, P_twoi));
    return rcpp_result_gen;
END_RCPP
}
